...
const experiences: ExperienceItem[] = [
  ...
  },
  {
    ...
    period: "2025 - 2026",
    description:
      "Design & Prototype in-car central display interfaces; Conduct competitive benchmarking; Lead conceptual explorations of future scenarios;",
  },
  {
    type: "Work",
    ...
    period: "2025",
    description:
      "Design & refine DIM to ensure clarity and seamless information delivery; Conduct internal & external usability test; Optimize interaction logic and information hierarchy;",
  },
  {
    type: "Work",
    role: "UX Design Intern",
    ...
    period: "2022 - 2023",
    description:
      "Design core products’ interfaces, responsible for process from strategy to execution; Assist in usability test and information architecture;",
  },
  {
    type: "Work",
    ...
    period: "2022",
    description:
      "Lead stool structure course and physical prototyping; Guide students in structural design, iterative prototyping, and feasibility refinement.",
  },
  // Education
  {
    type: "Education",
  ...
  },
  {
    ...
    organization:
      "UN International Student Conference on Sustainability ",
    period: "First Prize",
  },
  {
    type: "Award",
...
const exhibits = experiences.filter(
  (e) => e.type === "Exhibit",
);
...
const ExperienceRow = memo(function ExperienceRow({
  ...
  const showOrganization =
    item.type !== "Award" && item.type !== "Exhibit";
