    ...
    >
      ...
      <div className="flex-grow flex flex-col justify-center items-center z-10 relative gap-8">
        ...
        <p className="font-['DM_Sans'] text-sm sm:text-base text-black/40 max-w-md text-center text-pretty">
          I'm always open for new ideas and collaborations.
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 border-t border-black/10 pt-10 z-10">
        ...
        <div className="flex flex-col gap-2">
          <h3 className="font-['IBM_Plex_Mono'] text-[10px] uppercase tracking-widest text-black/30 mb-2">
            CONNECT
          </h3>
          <a
            href="https://www.linkedin.com/in/tianqi-jade-xiong-a310782a0/"
            target="_blank"
            rel="noopener noreferrer"
            className="font-['IBM_Plex_Mono'] text-sm hover:text-accent-blue transition-colors"
          >
            <AsciiText text="LINKEDIN" />
          </a>
          <a
            href="https://www.youtube.com/@TianqiXiong"
            target="_blank"
            rel="noopener noreferrer"
            className="font-['IBM_Plex_Mono'] text-sm hover:text-accent-blue transition-colors"
          >
        ...
        <div className="flex flex-col gap-2">
          ...
          <a
            href="https://tianqixiong-lab.github.io/public/resume.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="font-['IBM_Plex_Mono'] text-sm hover:text-accent-blue transition-colors"
          >
        ...
        <div className="flex flex-col gap-2 lg:items-end">
          <h3 className="font-['IBM_Plex_Mono'] text-[10px] uppercase tracking-widest text-black/30 mb-2 lg:text-right">
            BASED IN
          </h3>
